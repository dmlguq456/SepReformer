...
% data_type = {'cv','tt'};
data_type = {'tr','cv','tt'};
wsj0root = '/home/nas/user/Uihyeop/DB/wsj0-mix/2speakers/wav16k/css_v3'; % YOUR_PATH/, the folder containing wsj0/
output_dir16k='/home/nas/user/Uihyeop/DB/wsj0-mix/2speakers/wav16k/css_v3_segment_short';
% output_dir8k='/home/nas/user/Uihyeop/DB/wsj0-mix/2speakers/wav8k/css_v3_segment';

min_max = 'css_v3_segment_short';
% min_max = {'min','max', 'css'};
